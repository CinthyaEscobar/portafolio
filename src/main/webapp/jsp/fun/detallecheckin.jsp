...
<body id="page-top" class="bg-gradient-primary">
								...
								<div class="col-lg-12">
										...
										<div class="card canvas_div_pdf">
											<div class="row">
												<div class="col"> 
													...
													<img src="data:image/jpg;base64, ${ reserva.idDepartamento.getImg() }" alt="preview" width="350" height="350"/> 
												</div>
												<div class="col">
												<br>
												<br>
										 ...
										 <div class="row justify-content-center">
										 	<div class="col justify-content-center">
										 		...
										 		<h6 style="text-align: center;">Prepago: $ <c:out value="${ reserva.pagoReserva }" /></h6>	
										 		<h6 style="text-align: center;">Pago check-in: $ <c:out value="${ reserva.totalPagar - reserva.pagoReserva }" /></h6>	
										 	</div>
										 </div>
										 <div class="row justify-content-center">
										 	<div class="col justify-content-center">
									...
									<div class="card canvas_div_pdf">
										<hr>
										 ...
										 <div class="row justify-content-center">
										 	<div class="col justify-content-center">	
										 		<form action="/generarcheckin" method="post" id="formCancelar">
										 			<input type="hidden" value="${ reserva.idReserva }" name="idReserva">
										 			<input  style="margin:auto;  display:block" type="button" value="Check-in" onclick="validar()">										 			
										 		</form>	
										 		<br>
										 	</div>
										 </div>
    ...
    function validar()
	{
		if(confirm("¿Está seguro que desea realizar el Check-in?"))
		{
