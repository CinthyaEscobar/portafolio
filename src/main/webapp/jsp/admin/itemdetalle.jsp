								...
								<div class="col-lg-12">
									<div class="p-5">
										<div class="text-center">
											<h1 class="h4 text-gray-900 mb-4">Modificar Items</h1>
										</div>
										<form action="/item/actualizar" method="post" class="user">
												...
												<select name="departamento" class="form-select form-control" >													
													<c:forEach items="${ departamento }" var="de">
														<c:choose>
															...
															<c:when test="${ item.idDepartamento.idDepartamento == de.idDepartamento }">
																<option value="${ de.idDepartamento }" selected>
																	<c:out
																value="${ de.idEdificio.nombre  } - ${de.numero }" />
																</option>
															</c:when>
															<c:otherwise>
											...
											<div class="form-group row">
												<div class="col-sm-12 mb-6 mb-sm-0">
													<input type="text" placeholder="Nombre" name="nombre" required class="form-control form-control-user" value="${ item.nombre}">
												</div>
											</div>
											<div class="form-group row">
												<div class="col-sm-12 mb-6 mb-sm-0">
													<input type="text" placeholder="Descripción" name="descripcion" required class="form-control form-control-user" value="${ item.descripcion}">
												</div>
											</div>
											<div class="form-group row">
												<div class="col-sm-12 mb-6 mb-sm-0">
													<input type="number" placeholder="Costo" name="costo" required class="form-control form-control-user" value="${ item.costo}">
												</div>
											</div>
											<div class="form-group " >
											...
											<input type="hidden" value="${ item.idItem }" name="id">											
