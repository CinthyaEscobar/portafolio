								...
								<div class="col-lg-12">
									<div class="p-5">
										<div class="text-center">
											<h1 class="h4 text-gray-900 mb-4">Registrar Servicio Transporte</h1>
										</div>
										<form action="/transporte/agregar" method="post" class="user">
											<div class="form-group">
												<select name="conductor" class="form-select form-control"  >													
												
													<c:forEach items="${ conductor }" var="co">
														<option value="${ co.idConductor }" ><c:out
																value="${ co.rut }" />
														</option>
													</c:forEach>
												</select>
											...
											<div class="form-group">
												<select name="vehiculo"class="form-select form-control">													
													<c:forEach items="${ vehiculo  }" var="ve">
														<option value="${ ve.idVehiculo } " ><c:out
																value="${ ve.patente } - ${ ve.marca }  - ${ ve.modelo }"  />
														</option>
													</c:forEach>
												</select> 
											</div>
											<div class="form-group row">
												<div class="col-sm-12 mb-6 mb-sm-0">
													<input type="number" placeholder="Precio Transporta" name="precio" required class="form-control form-control-user">
												</div>
												</div>
