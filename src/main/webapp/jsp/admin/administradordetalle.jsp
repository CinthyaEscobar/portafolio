								...
								<div class="col-lg-12">
									<div class="p-5">
										<div class="text-center">
											<h1 class="h4 text-gray-900 mb-4">Modificar un Administrador</h1>
										</div>
										<form action="/administrador/modificar" method="post" class="user">
	...
	<div class="modal fade" id="logoutModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">¿Esta segurro que quiere cerrar
					sesión?</div>
