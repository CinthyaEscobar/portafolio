								...
								<div class="col-lg-12">
									<div class="p-5">
										<div class="text-center">
											<h1 class="h4 text-gray-900 mb-4">Registrar un Vehículo</h1>
										</div>
										<form action="/vehiculo/agregar" method="post" class="user">
											<div class="form-group row">
												<div class="col-sm-12 mb-6 mb-sm-0">
													<input type="text" placeholder="Patente" name="patente" required class="form-control form-control-user">
												</div>
											</div>
											<div class="form-group row">
												<div class="col-sm-12 mb-6 mb-sm-0">
													<input type="text" placeholder="Marca" name="marca" required class="form-control form-control-user">
												</div>
											</div>
											<div class="form-group row">
												<div class="col-sm-6 mb-3 mb-sm-0">
													<input type="text" placeholder="Mdelo" name="modelo" required class="form-control form-control-user">
												</div>
												<div class="col-sm-6 mb-3 mb-sm-0">
													<input type="text" placeholder="Año" name="anio" required class="form-control form-control-user">
												</div>
											</div>											
