	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				data-toggle="collapse" data-target="#collapseTwo"> <span>Servicios</span>
			</a>
										...
										<div class="col-lg-12">
											<div class="p-5">
												<div class="text-center">
													<h1 class="h4 text-gray-900 mb-4">Modificar un
														Edificio</h1>
												</div>
												<form action="/edificio/actualizar" method="post"
													...
													<div class="form-group">
														<select name="region" class="form-select form-control"
															...
															<c:forEach items="${ region }" var="re">
																<c:choose>
																	<c:when
																		test="${ edificio.idDireccion.idCo.idPr.idRe.idRe == re.idRe }">
													...
													<div class="form-group">
														<select name="provincia" class="form-select form-control"
															...
															<c:forEach items="${ provincia  }" var="pr">
																<c:choose>
																	<c:when
																		test="${ edificio.idDireccion.idCo.idPr.idPr == pr.idPr }">
													...
													<div class="form-group">
														<select name="comuna" class="form-select form-control"
															...
															<c:forEach items="${ comuna  }" var="co">
																<c:choose>
																	<c:when
																		test="${ edificio.idDireccion.idCo.idCo == co.idCo }">
													...
													<div class="form-group row">
														<div class="col-sm-6 mb-3 mb-sm-0">
															<input type="text" placeholder="Calle" name="calle"
																...
																value="${ edificio.idDireccion.calle}">
														</div>
														<div class="col-sm-6 mb-3 mb-sm-0">
															<input type="number" placeholder="Número" name="numero"
																required class="form-control form-control-user"
																value="${ edificio.idDireccion.numero}">
														</div>
													</div>
													<div class="form-group row">
													...
													<input type="hidden"
														value="${ edificio.idDireccion.idDireccion }" name="idDi">
													<input type="hidden" value="${ edificio.idEdificio }"
														name="idEd"> <input type="submit"
														value="Actualizar"
