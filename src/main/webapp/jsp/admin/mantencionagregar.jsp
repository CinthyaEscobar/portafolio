								...
								<div class="col-lg-12">
									<div class="p-5">
										<div class="text-center">
											<h1 class="h4 text-gray-900 mb-4">Registrar Mantención Departamentos </h1>
										</div>
										<form action="/mantencion/agregar" method="post" class="user">
											<div class="form-group">
												<select name="departamento" class="form-select form-control"  >													
													<c:forEach items="${ departamento }" var="de">
														<option value="${ de.idDepartamento }" ><c:out
											...
											<div class="form-group row">
												<div class="col-sm-12 mb-6 mb-sm-0">
													<input type="date" placeholder="Fecha" name="fecha" id="fecha_desde" required class="form-control form-control-user">
												</div>
												</div>
												...
												<select name="tipomantencion" class="form-select form-control"  >													
													<c:forEach items="${ tipomantencion }" var="ti">
														<option value="${ ti.idTipomantencion }" ><c:out
																value="${ ti.descripcion  }" />
														</option>
													</c:forEach>
												</select>
											</div>
												<div class="form-group row">
												<div class="col-sm-12 mb-6 mb-sm-0">
													<input type="number" placeholder="Costo" name="costo" required class="form-control form-control-user">
												</div>
												</div>																					
