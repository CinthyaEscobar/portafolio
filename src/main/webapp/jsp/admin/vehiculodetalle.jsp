								...
								<div class="col-lg-12">
									<div class="p-5">
										<div class="text-center">
											<h1 class="h4 text-gray-900 mb-4">Modificar un Vehículo</h1>
										</div>
										<form action="/vehiculo/modificar" method="post" class="user">
											
											<div class="form-group row">
												<div class="col-sm-12 mb-6 mb-sm-0">
													<input type="text" placeholder="patente" name="patente" required class="form-control form-control-user" value="${ vehiculo.patente }">
												</div>
											</div>
											<div class="form-group row">
												<div class="col-sm-12 mb-6 mb-sm-0">
													<input type="text" placeholder="marca" name="marca" required class="form-control form-control-user"  value="${ vehiculo.marca }">
												</div>
											</div>
											<div class="form-group row">
											
												<div class="col-sm-12 mb-6 mb-sm-0">
													<input type="text" placeholder="modelo" name="modelo" required class="form-control form-control-user"  value="${ vehiculo.modelo }">
												</div>
												</div>
											<div class="form-group row">
												<div class="col-sm-12 mb-6 mb-sm-0">
													<input type="number" placeholder="anio" name="anio" required class="form-control form-control-user"  value="${ vehiculo.anio }">
												</div>												
											</div>
											<input type="hidden" value="${ vehiculo.idVehiculo }" name="idVe">
