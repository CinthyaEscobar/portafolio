								...
								<div class="col-lg-12">
									<div class="p-5">
										<div class="text-center">
											<h1 class="h4 text-gray-900 mb-4">Modificar un Funcionario</h1>
										</div>
										<form action="/funcionario/modificar" method="post" class="user">
											
											<div class="form-group row">
												<div class="col-sm-12 mb-6 mb-sm-0">
													<input type="text" placeholder="correo" name="correo" required class="form-control form-control-user" value="${ cuenta.correo }">
												</div>
												</div>
												<div class="form-group row">
												<div class="col-sm-12 mb-6 mb-sm-0">
													<input type="text" placeholder="Rut" name="rut" required class="form-control form-control-user"  value="${ cuenta.rut }">
												</div>
												</div>
												<div class="form-group row">
												<div class="col-sm-12 mb-6 mb-sm-0">
													<input type="text" placeholder="Nombre" name="nombre" required class="form-control form-control-user"  value="${ cuenta.nombre }">
												</div>
												</div>
													<div class="form-group row">
												<div class="col-sm-12 mb-6 mb-sm-0">
													<input type="text" placeholder="Apellido Paterno" name="apellidop" required class="form-control form-control-user"  value="${ cuenta.apellidop }">
												</div>
												</div>
													<div class="form-group row">
												<div class="col-sm-12 mb-6 mb-sm-0">
													<input type="text" placeholder="Apellido Materno" name="apellidom" required class="form-control form-control-user"  value="${ cuenta.apellidom }">
												</div>
												</div>
												<div class="form-group row">
												<div class="col-sm-12 mb-6 mb-sm-0">												
												<c:choose>
													<c:when test="${ cu.telefono != 0 }">
														<input type="number" placeholder="teléfono" name="telefono"  class="form-control form-control-user"  value="${ cuenta.telefono }">
													</c:when>
													<c:otherwise>
														<input type="number" placeholder="teléfono" name="telefono"  class="form-control form-control-user"  value="">
													</c:otherwise>
												</c:choose>
												</div>	
												</div>											
													<div class="form-group row">
												<div class="col-sm-12 mb-6 mb-sm-0">
													<input type="number" placeholder="celular" name="celular" required class="form-control form-control-user"  value="${ cuenta.celular }">
												</div>
												</div>
												<div class="form-group row">
												<div class="col-sm-12 mb-6 mb-sm-0">
													<input type="password" placeholder="password" name="password" class="form-control form-control-user"  value="">
												</div>
												</div>
												<div class="form-group row">
												<div class="col-sm-12 mb-6 mb-sm-0">
												<select name="edificio" class="form-select form-control" >													
													<c:forEach items="${ edificios }" var="ed">
														<c:choose>
														
															<c:when test="${ funcionario.idEdificio.idEdificio == ed.idEdificio }">
																<option value="${ ed.idEdificio }" selected>
																	<c:out
																value="${ ed.nombre  } " />
																</option>
															</c:when>
															<c:otherwise>
																<option value="${ ed.idEdificio}" >
																	<c:out
																value="${ ed.nombre  } " />
																</option>
															</c:otherwise>
											...
											<input type="hidden" value="${ funcionario.idFuncionario}" name="idFu">
											<input type="hidden" value="${ cuenta.idCuenta}" name="idCu">
