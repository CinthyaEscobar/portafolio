								...
								<div class="col-lg-12">
									<div class="p-5">
										<div class="text-center">
											<h1 class="h4 text-gray-900 mb-4">Modificar un Conductor</h1>
										</div>
										<form action="/conductor/modificar" method="post" class="user">
											
											<div class="form-group row">
												<div class="col-sm-12 mb-6 mb-sm-0">
													<input type="text" placeholder="rut" name="rut" required class="form-control form-control-user" value="${ conductor.rut }">
												</div>
												</div>
												<div class="form-group row">
												<div class="col-sm-12 mb-6 mb-sm-0">
													<input type="text" placeholder="nombre" name="nombre" required class="form-control form-control-user"  value="${ conductor.nombre }">
												</div>
												</div>
												<div class="form-group row">
												<div class="col-sm-12 mb-6 mb-sm-0">
													<input type="text" placeholder="Apellido" name="apellidop" required class="form-control form-control-user"  value="${ conductor.apellidop }">
												</div>
												</div>
												
											<input type="hidden" value="${ conductor.idConductor }" name="idCo">
