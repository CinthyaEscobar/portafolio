								...
								<div class="col-lg-12">
									<div class="p-5">
										<div class="text-center">
											<h1 class="h4 text-gray-900 mb-4">Registrar un Edificio</h1>
										</div>
										<form action="/edificio/agregar" method="post" class="user">
											...
											<div class="form-group">
												<select name="provincia"class="form-select form-control" id="sel2" onchange="cargarTres(this.value)">													
													<c:forEach items="${ provincia  }" var="pr">
														<option value="${ pr.idPr  }" data-option="${ pr.idRe.idRe}"><c:out
											...
											<div class="form-group">
												<select name="comuna" class="form-select form-control" id="sel3"> 													
													<c:forEach items="${ comuna  }" var="co" >
														<option value="${ co.idCo  }" data-option="${ co.idPr.idPr}"><c:out
											...
											<div class="form-group row">
												<div class="col-sm-12 mb-6 mb-sm-0">
													<input type="text" placeholder="Calle" name="calle" required class="form-control form-control-user">
												</div>
												</div>
												<div class="form-group row">
												<div class="col-sm-12 mb-6 mb-sm-0">
													<input type="text" placeholder="Número" name="numero" required class="form-control form-control-user">
												</div>
												</div>
											
											<div class="form-group row">
											<div class="col-sm-12 mb-6 mb-sm-0">
													<input type="text" placeholder="Nombre Edificio" name="nombre" required class="form-control form-control-user">
												</div>
											</div>
