								...
								<div class="col-lg-12">
									<div class="p-5">
										<div class="text-center">
											<h1 class="h4 text-gray-900 mb-4">Modificar un Departamento</h1>
										</div>
										<form action="/departamento/modificar" method="post" class="user" enctype="multipart/form-data">
											
											<div class="form-group row">
												<div class="col-sm-12 mb-6 mb-sm-0">
													<input type="number" placeholder="numero" name="numero" required class="form-control form-control-user" value="${departamento.numero }">
												</div>
											</div>
											<div class="form-group row">
												<div class="col-sm-12 mb-6 mb-sm-0">
													<input type="number" placeholder="piso" name="piso" required class="form-control form-control-user" value="${ departamento.piso }">
												</div>
											</div>
											<div class="form-group row">
												<div class="col-sm-12 mb-6 mb-sm-0">
													<input type="number" placeholder="tarifa" name="tarifa" required class="form-control form-control-user" value="${ departamento.tarifa }">
												</div>
											</div>
											<div class="form-group row">
												<div class="col-sm-12 mb-6 mb-sm-0">
													<input type="number" placeholder="porcentaje reserva" name="porcentajeReserva" required class="form-control form-control-user" value="${ departamento.porcentajeReserva }">
												</div>
											</div>
											<div class="form-group row">
												<div class="col-sm-12 mb-6 mb-sm-0">
													<input type="text" placeholder="Descripcion" name="descripcion" required class="form-control form-control-user" value="${ departamento.descripcion }">
												</div>
											</div>
											<div class="form-group row">
												<select name="edificio" class="form-select form-control"  id="sel1" onchange="cargarDos(this.value)" >
													<c:forEach items="${ edificios }" var="ed">
														<c:choose>
															<c:when test="${ departamento.idEdificio.idEdificio == ed.idEdificio }">
																<option value="${ ed.idEdificio }" selected><c:out value="${ ed.nombre }" /></option>
															</c:when>
															<c:otherwise>
											...
											<div class="form-group row">
												<select name="estado" class="form-select form-control"  id="sel1" onchange="cargarDos(this.value)" >
													<c:forEach items="${ estados }" var="es">
														<c:choose>
															<c:when test="${ departamento.idEstado.idEstado == es.idEstado }">
																<option value="${ es.idEstado }" selected><c:out value="${ es.descripcion }" /></option>
															</c:when>
															<c:otherwise>
																<option value="${ es.idEstado }"><c:out value="${ es.descripcion }" /></option>
															</c:otherwise>
														</c:choose>														
													</c:forEach>
												</select>
											...
											<div class="form-group " >
												...
												<c:choose>
													<c:when  test='${ departamento.activo == "1" }'>
											...
											<div class="form-group justify-content-center" >
												<img id="blah" alt="preview" src="data:image/jpg;base64, ${ departamento.getImg() }" width="250" height="250">
											</div>		
												
												
											<input type="hidden" value="${ departamento.idDepartamento }" name="idDe">											
											<input type="hidden" value="${ departamento.getImg() }" name="oldPic">
											<input type="hidden" value="${ departamento.idEdificio.idEdificio }" name="idEd">
											<input type="submit" value="Modificar" class="btn btn-primary btn-user btn-block"> 
										</form>
									</div>
								</div>
							</div>
