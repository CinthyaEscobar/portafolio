			...
			<li class="nav-item"><a class="nav-link" href="/departamento"
				...
				<div id="collapseOne" class="collapse" aria-labelledby="headingOne"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="/mantencion">Mantención</a> <a
				...
				<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="/transporte">Transportes</a> <a
							...
							class="collapse-item" href="/vehiculo">Vehículos</a>
					</div>
				</div></li>
			<!-- Nav items -->
			    <li class="nav-item">
										...
										<div class="col-lg-12">
											<div class="p-5">
												<div class="text-center">
													<h1 class="h4 text-gray-900 mb-4">Registrar un Tour</h1>
												</div>
												<form action="/tour/agregar" method="post" class="user"
													enctype="multipart/form-data">
													<div class="form-group">
														<select name="region" class="form-select form-control"
															id="sel1" onchange="cargarDos(this.value)">
															<c:forEach items="${ region }" var="re">
																<option value="${ re.idRe }"><c:out
																		value="${ re.strDescripcion }" />
																</option>
															</c:forEach>
														</select>
													</div>
													<div class="form-group">
														<select name="provincia" class="form-select form-control"
															id="sel2" onchange="cargarTres(this.value)">
															<c:forEach items="${ provincia  }" var="pr">
																<option value="${ pr.idPr  }"
																	data-option="${ pr.idRe.idRe}"><c:out
																		value="${ pr.strDescripcion }" />
																</option>
															</c:forEach>
														</select>
													</div>
													<div class="form-group">
														<select name="comuna" class="form-select form-control"
															id="sel3">
															<c:forEach items="${ comuna  }" var="co">
																<option value="${ co.idCo  }"
																	data-option="${ co.idPr.idPr}"><c:out
																		value="${ co.strDescripcion }" />
																</option>
															</c:forEach>
														</select>
													</div>
													...
													<div class="form-group">
														<input type="text" placeholder="cantidad participantes"
													...
													<div class="form-group">
														<label for="exampleFormControlTextarea1">Fecha</label> <input
															type="date" placeholder="Fecha" name="fecha" required
															class="form-control form-control-user" id="fecha_desde">
													</div>
													<div class="form-group row">
														<div class="col-sm-6 mb-3 mb-sm-0">
															<label for="comienzoId">Comienzo</label> <input
																id="comienzoId" type="time" placeholder="comeinzo"
																name="comienzo" required
																class="form-control form-control-user">
														</div>
														<div class="col-sm-6 mb-3 mb-sm-0">
															<label for="terminoId">Termino</label> <input
																id="terminoId" type="time" placeholder="termino"
													...
													<div class="form-group">
														<div class="custom-file">
															<input type="file" class="custom-file-input"
																id="customFileLang" lang="es" name="foto"
																accept="image/png,image/jpg,image/jpeg"> <label
																class="custom-file-label" for="customFileLang">Seleccionar
																Archivo</label>
														</div>
													</div>
													<div class="form-group justify-content-center">
														<img id="blah" src="#" alt="preview" width="250"
															height="250" />
													</div>
